...
from PS3838_support_function                                                   import encode_decode, match_filter_prediction, optimisation_7, optimisation_7_apply


# =============================================================================
# PLACE REAL ORDER
# =============================================================================
def ps3838_bet_single(df_single, df_merge_single, GMT_to_add):
    ...
    df_single_filter = optimisation_7_apply(df_single, dict_parameter_sport)
    ...
    if len(df_betting_single) != 0:
        ...
        if date_text.strftime("%w") in ['0','5','6']:
            ...
            if len(df_betting_single_S_all) != 0:
                for i in range(len(df_betting_single_S_all)):
                    df_betting_single_S               = pd.DataFrame(df_betting_single_S_all.iloc[i]).T
            ...
            ###
            df_betting_single_WNB_all             = df_betting_single[df_betting_single.mode_bet == 'WNB']
...
#                print 'lose'
    ...
    if len(df_parlay_filter_simulator_single)>=1:
        ...
        date_bet = datetime.now()+timedelta(hours=GMT_to_add)

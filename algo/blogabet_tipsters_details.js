...
async function Oddsportal_scrap(invisible_nav) {
    ...
    // GO TO PAGE
    await page.goto(candidate_link, {timeout : 0});    
    var selector = '#_data > div.container.stats'
    await page.waitForSelector(selector)
    await page.waitFor(1 * 1000);
    clickByXPATH(page, '//*[@id="page-container"]/div/div/div[1]/a');
    await page.waitFor(1 * 1000);
    clickByXPATH(page, '//*[@id="_blog-menu"]/div[2]/div/div[2]/a[3]');
